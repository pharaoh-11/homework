const { helper1: sort, helper2: getMostExpensive, helper3: addPriceKey } = require('./helpers');
...
function boot(goodsArray) {
  ...
  console.log(`Here is the most expensive good by the total price from sorted goods:`);
  console.log(getMostExpensive(oranges.concat($4KilogramGoods)));

  console.log(`Here is the result of helper3 with 2 results of helper1`);
  console.log(oranges.concat($4KilogramGoods).map((good) => addPriceKey(good)));
